...
<div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-8 lg:py-12">
  <div class="relative w-full bg-white px-6 py-12 shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:mx-auto md:max-w-3xl lg:max-w-4xl lg:pt-16 lg:pb-28">
    ...
    <br></br>
      ...
      <p>When it comes to chosing the "color" of your diamond, it is exetrmly important. Chosing the right color
      is important because it is one of the most noticable things about the diamond. The worst the color grade is,
      the more more yellow the diamond is. I would suggest that if you have a few extra dollars to spend, make sure some of
      that extra money in invested into the color of the diamond... you can thank me later.
      </p>
      <p class="lead">Fluorescent diamonds-</p>
      <p>You probably thought it was a joke when you say the word fluorescent, but no, it is indeed a factor! In fact,
      this could possibly be one of the biggest factors when choosing a diamond. You want to be sure that your diamond is not
      fluorescent at all, as this can cause your diamond to look very blue and much less apealing when under natural light.
      You will only see this effect under natural light, so don't be fooled when shopping at the jewlers!</p>
      <p class="lead">Which color to chose -</p>
      <p>Per the graph shown below, you can see that there can be a pretty drastic diffrence between the colors of diamonds.
