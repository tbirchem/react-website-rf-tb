...
<h1 class="bg-clip-text text-transparent from-green-100 to-blue-700 bg-gradient-to-t"> Color of a Diamond </h1>
    <br></br>
      <p class="lead">Color in a diamond - </p>
      <p class="font-serif">When it comes to choosing the "color" of your diamond, it is extremely important. Choosing the right color
      ...
      <p class="font-serif">You probably thought it was a joke when you saw the word fluorescent, but no, it is indeed a factor! In fact,
      ...
      <p class="font-serif">Per the graph shown below, you can see that there can be a pretty drastic difference between the colors of diamonds.
